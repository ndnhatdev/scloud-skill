---
name: rust-ecosystem
description: Practical Rust backend ecosystem guidance for Tokio, Serde, Axum, SQLx, and Tracing. Use when Codex needs to design or review async services, app state, request handlers, serialization, database access, migrations, structured logging, graceful shutdown, or integration patterns in modern Rust applications.
---
